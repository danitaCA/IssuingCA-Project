...
public interface CertificateRepository extends JpaRepository<CertificateEntity, Long> {
    ...
    List<CertificateEntity> findByCertificateTypeIn(List<String> certificateTypes);
    List<CertificateEntity> findByCertificateType(String certificateType);
    List<CertificateEntity> findByIssuerDNAndStatusIn(String issuerDN, List<String> statuses);
}
